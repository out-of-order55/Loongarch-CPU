...
#
# Generated by export_simulation on Fri Mar 15 10:40:43 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './clk_pll.sh' script.

./clk_pll.sh -reset_run
...
./clk_pll.sh -noclean_files

For more information on the script, please type './clk_pll.sh -help'.
