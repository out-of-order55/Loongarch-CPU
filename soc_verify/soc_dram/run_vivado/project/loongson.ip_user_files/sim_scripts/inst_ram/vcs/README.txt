...
#
# Generated by export_simulation on Fri Mar 15 10:50:43 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './inst_ram.sh' script.

./inst_ram.sh -reset_run
...
./inst_ram.sh -noclean_files

For more information on the script, please type './inst_ram.sh -help'.
