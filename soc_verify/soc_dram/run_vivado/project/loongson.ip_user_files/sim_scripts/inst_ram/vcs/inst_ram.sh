...
#
# Generated by Vivado on Fri Mar 15 10:50:43 +0800 2024
...
# executing this script. Please type 'inst_ram.sh -help' for more information.
#
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../../../rtl/xilinx_ip/inst_ram/sim/inst_ram.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inst_ram xil_defaultlib.glbl -o inst_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inst_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inst_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc inst_ram_simv.daidir)
